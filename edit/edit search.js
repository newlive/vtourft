...
$(document).one("ajaxStop", function () {
  ...
  // name: "gdg^",
  // displayKey: "nama_gdg",
  // source: gdg^BH.ttAdapter(),
  // templates: {
  //   header: "<h4 class='typeahead-header'><img src='assets/img/building.png' width='24' height='28'>&nbsp;Gedung @</h4>",
  ...
  //   }
    ...
    // if (datum.source === "gdg^") {
    //   if (!map.hasLayer(gdg0^Layer)) {
    //     map.addLayer(gdg0^Layer);
    //   }
